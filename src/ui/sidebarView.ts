            ...
            switch (message.type) {
                ...
                case 'sidebar:import': {
                    ...
                    try {
                        ...
                        // Build existing contracts list from current sidebar
                        ...
                        const result = await applyImport(
                            ...
                            selection,
                            {
                                ...
                                applyContracts: async (contracts) => {
                                    // Persist updated contract list via workspace state
